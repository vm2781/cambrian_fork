...
def process(line, args, tokenizer, image_processor, model_config):
    ...
    if line["image_1"] is None:
        ...
        real_image = line["image_1"].convert('RGB')
...
def eval_model(args):
    ...
    for line in tqdm(questions, total=len(questions)):
        ...
        input_ids, image_tensor, image_sizes, prompt, image, qs = process(line, args, tokenizer, image_processor, model.config)
        ...
        if example_num < 3:
            try:
                ...
                img_dir = "examples/mmmu/rdm_nul" + str(example_num) + ".png"
