...
def process(line, wrong_line, args, tokenizer, image_processor, model_config):
    ...
    right_qs = re.sub(r'<image \d+>', '', right_qs).strip()
    ...
    return input_ids, image_tensor, image_size, prompt, image, qs, right_qs
...
def eval_model(args):
    ...
    for line in tqdm(questions, total=len(questions)):
        ...
        input_ids, image_tensor, image_sizes, prompt, image, qs, right_txt = process(line, wrong_line, args, tokenizer, image_processor, model.config)
        ...
        if example_num < 3:
            try:
                ...
                img_dir = "examples/runon/mmmu/img_" + str(example_num) + "_shuffle.png"
                ...
                img_dir2 = "examples/runon/mmmu/img_" + str(example_num) + "_real.png"
