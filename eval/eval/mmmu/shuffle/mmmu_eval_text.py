...
def eval_model(args):
    ...
    for line, wrong_line in tqdm(zip(questions, shuffled_questions), total=len(questions)):
        ...
        input_ids, image_tensor, image_sizes, prompt, image, qs = process(line, wrong_line, args, tokenizer, image_processor, model.config)
        ...
        if example_num < 3:
            try:
                ...
                img_dir = "examples/mmmu/txt_shu" + str(example_num) + ".png"
