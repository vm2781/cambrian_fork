...
def process(line, wrong_line, wrong_img_line, args, tokenizer, image_processor, model_config):
...
def eval_model(args):
    ...
    for line, wrong_line, wrong_img_line in tqdm(zip(questions, shuffled_questions, shuffled_questions2), total=len(questions)):
        ...
        if idx<valid_chunk[0] or idx>valid_chunk[1]:
            continue
        input_ids, image_tensor1, image_tensor2, image_tensor3, image_tensor4, image_sizes, prompt = process(line, wrong_line, wrong_img_line, args, tokenizer, image_processor, model.config)
